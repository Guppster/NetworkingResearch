...
#    What software, hardware, or tools did you use?
---
...
---
#    What were the most difficult issues and challenges in the implementation?
#    Give code details (not a complete listing, but descriptions of key parts). Discuss only the most important/interesting aspects.
#    Include a test plan. How the program/system was verified? Put the actual test results in the Appendix.
---
...
---
#    What is the end product? (application, data visualization, report, etc.)
#    Describe all the features of the end product.
#
#    Provide details of experiments/simulations that were carried out with the
#    code written. Why were certain experiments carried out but not others? What
#    were the important parameters in the simulation and how did they affect the
#    results?
#
#    You can put all the graphs and tables in the Appendix, but it is generally
#    better to keep these close to the text they illustrate, as this is easier for
#    the reader.
---
