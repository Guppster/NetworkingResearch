...
// JDK 7 and above
public class Injection {  // Save as "JavaProject"
  ...
  public static void main(String[] args) {
      ...
      try (
        ...
        String min_grade=input.nextLine();
        
        System.out.println(min_grade);

         // Step 3: Execute a SQL SELECT query, the query result
         //  is returned in a "ResultSet" object.
         String strSelect = "select * from students where grade> " + min_grade;
